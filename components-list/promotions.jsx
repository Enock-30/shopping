const  Promotions = ()=>{
    return ( 
        <div className="relative overflow-hidden bg-white-400 mt--60">
        ...
        <div className="mt-10">
          ...
          <div aria-hidden="true" className="pointer-events-none lg:absolute lg:inset-y-0 lg:mx-auto lg:w-full lg:max-w-7xl">
            <div className="absolute transform sm:top-0 sm:left-1/2 sm:translate-x-8 lg:top-1/2 lg:left-1/2 lg:translate-x-8 lg:-translate-y-1/2">
              <div className="flex items-center space-y-4 xl:space-x-3 ">
                <div className="grid shrink-0 grid-cols-1 gap-y-4 lg:gap-y-4">
                ...
                <div className="grid shrink-0 grid-cols-1 gap-y-3 lg:gap-y-3">
                ...
                <div className="grid shrink-0 grid-cols-1 gap-y-3 lg:gap-y-4">
                  <div className="h-64 w-44 overflow-hidden rounded-lg">
